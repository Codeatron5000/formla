...
function utils_clone(obj) {
  ...
  if (isFile(obj) || ['number', 'string', 'boolean'].includes(_typeof(obj))) {
    return obj;
  }
  ...
  if (isObj(obj)) {
    ...
    Object.keys(obj).forEach(function (key) {
      return target[key] = utils_clone(obj[key]);
    });
    return target;
  }
}
...
function () {
  ...
  Form_createClass(Form, [{
    ...
    value: function getData() {
      return _objectSpread({}, this._data, {}, this._originalConstantData);
    }
  }, {
    key: "setData",
    ...
    value: function reset() {
      for (var field in this._data) {
        set(this._data, field, this.parseData(_get(this._originalData, field)));
      }
    ...
    value: function clear(field) {
      if (hasOwn(this, field)) {
        set(this._data, field, emptyValue(_get(this._data, field)));
      }
    ...
    value: function parseData(data) {
      return this._options.clone ? utils_clone(data) : data;
    }
  }, {
    ...
    value: function graphql(query, options) {
      ...
      options = options || {};
      var originalFormatDataCallback = options.formatData || this._options.formatData;
    ...
    value: function submit(method, url, options) {
      ...
      var requestOptions = _objectSpread({}, this._options, {}, options);
