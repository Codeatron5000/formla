  ...
  Form_createClass(Form, [{
    ...
    value: function reset() {
      for (var field in this.data) {
        set(this.data, field, this.parseData(_get(this.originalData, field)));
      }
    ...
    value: function clear(field) {
      if (hasOwn(this, field)) {
        set(this.data, field, emptyValue(_get(this.data, field)));
      }
    ...
    value: function parseData(data) {
      return this.options.clone ? utils_clone(data) : data;
    }
  }, {
